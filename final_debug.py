...
def extract_json_from_response(text):
    ...
    try:
        ...
        print(f"[ERROR] Exception in extract_json_from_response: {e}")
        print(f"[DEBUG] Raw text: {repr(text)}")
        print(f"[DEBUG] Cleaned text: {repr(cleaned)}")
        raise
...
"""
    ...
    try:
        ...
        try:
            ...
            print(f"[ERROR] Exception in extract_json_from_response for {exp_id}: {e}")
        ...
        try:
            ...
            print(f"[ERROR] Exception in JSON parsing for {exp_id}: {e}")
            print(f"[DEBUG] Full traceback:")
            traceback.print_exc()
        
    except Exception as e:
        print(f"[ERROR] {exp_id} model call error: {e}")
        print(f"[DEBUG] Full traceback:")
        traceback.print_exc()
